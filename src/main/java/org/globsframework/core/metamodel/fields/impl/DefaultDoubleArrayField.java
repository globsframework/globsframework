...
public final class DefaultDoubleArrayField extends AbstractField implements DoubleArrayField {

    public DefaultDoubleArrayField(String name, Supplier<GlobType> globType,
                                   int index, boolean isKeyField, final int keyIndex, Double defaultValue, HashMap<Key, Glob> annotations) {
