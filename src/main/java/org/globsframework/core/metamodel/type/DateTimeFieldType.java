...
public class DateTimeFieldType {
    ...
    static {
        GlobTypeBuilder typeBuilder = new DefaultGlobTypeBuilder("DateTime");
...
//        GlobTypeLoaderFactory.create(DateTimeFieldType.class).load();
    }

    public static MutableGlob create(String name) {
        return TYPE.instantiate()
                .set(DateTimeFieldType.name, name);
    }
}
