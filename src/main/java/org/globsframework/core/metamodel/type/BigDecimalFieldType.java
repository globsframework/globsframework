...
public class BigDecimalFieldType {
    ...
    static {
        GlobTypeBuilder typeBuilder = new DefaultGlobTypeBuilder("BigDecimal");
...
//        GlobTypeLoaderFactory.create(BigDecimalFieldType.class).load();
    }

    public static MutableGlob create(String name) {
        return TYPE.instantiate()
                .set(BigDecimalFieldType.name, name);
    }
}
